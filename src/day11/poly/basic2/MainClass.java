...
//		Student s2 = new Student("이순신", 30, "123423");
//		Student s3 = new Student("홍길자", 20, "123128");
//		
...
//		Employee[] emps = {e1};
		...
		Person s2 = new Student("이순신", 30, "123423");
		Person s3 = new Student("홍길자", 20, "123128");		
		Person t1 = new Teacher("세종대왕", 30, "국어");
		Person t2 = new Teacher("신사임당", 20, "미술");		
		Person e1 = new Employee("장영실", 20, "개발부");
		
		Person[] persons = {s1, s2, s3, t1, t2, e1}; // 부모 타입 배열에 자식을 담을 수 있음
